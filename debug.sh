...
#当前路径 AIC/
cd code
python train.py --model_name SimpleNet --batch_size 64 --lr 0.0005 --epochs 1 --val_steps 0 --experiment_name webfg400 \
--train_dir ../data/webfg400/threshold/train --val_dir ../data/webfg400/threshold/val --device 'cuda:0'

python train.py --model_name SimpleNet --batch_size 64 --lr 0.0005 --epochs 1 --val_steps 0 --experiment_name webfg5000 \
